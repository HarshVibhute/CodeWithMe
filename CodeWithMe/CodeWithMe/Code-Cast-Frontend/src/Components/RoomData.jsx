...
const RoomData = () => {
    ...
    const getData = async (item) => {
        loadingStart();
        await axios.get(`${"https://codewithme-backend.onrender.com/" + "rooms/fetch"}?id=${item.roomid}`
            , {
                headers: {
    ...
    const createRoom = async () => {
        ...
        axios({
            method: 'post',
            url: "https://codewithme-backend.onrender.com/" + 'rooms/create',
            headers: {
                Authorization: `Bearer ${localStorage.getItem('user')}`
            },
            data: {
    ...
    const joinOtherRoom = async () => {
        ...
        axios({
            method: 'get',
            url: "https://codewithme-backend.onrender.com/" + `rooms/fetch?id=${roomID}`,
            headers: {
                Authorization: `Bearer ${localStorage.getItem('user')}`
            }
        })
    ...
    const deleteData = (item) => async () => {
        ...
        axios({
            method: 'delete',
            url: "https://codewithme-backend.onrender.com/" + `rooms/delete`,
            headers: {
                Authorization: `Bearer ${localStorage.getItem('user')}`
            },
            data: {
