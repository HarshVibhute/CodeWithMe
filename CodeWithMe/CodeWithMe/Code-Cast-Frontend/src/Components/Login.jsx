...
function Login() {
    ...
    useEffect(() => {
        ...
        if (token) {
            ...
            axios({
                method: 'get',
                url: "https://codewithme-backend.onrender.com/" + "users/fetch",
                headers: {
    ...
    const onSuccess = (credentialResponse) => {
        ...
        axios({
            method: 'post',
            url: "https://codewithme-backend.onrender.com/" + "users/login",
    ...
    async function registerUser(e) {
        ...
        if (passwordSame) {
          ...
          const url = "https://codewithme-backend.onrender.com/" + "users/register";
    ...
    function loginUser(e) {
        ...
        axios.post("https://codewithme-backend.onrender.com/" + "users/login", data).then((response) => {
            setUser(response.data.user);
            localStorage.setItem('user', response.data.token);
        }).catch((error) => {
